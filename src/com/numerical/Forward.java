/********************************************************************************************************************** 
    ...
    The following code implements the Newton Forward Interpolation. It is implemented as apart of the java package
	"com.numerical" This piece of code has the following components and dependencies.
	
    inputParameters() - Returns void - This method is used by the user to input the parameters
	
    differenceCal() - Returns void - Calculates the difference table values.
    ...
    forwardCal() - Returns void -  Calculates the value of the function at the pivot using forward interpolation.
	...
	The method of Forward Interpolation is used to find the value of a function at a point lying between two extreme
	...
	process will fail. 	The forward difference method is used to calculate the value of a function near the beginning 
